...
// MFCApp.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Único objeto CMFCAppApp

CMFCAppApp theApp;


// Inicialización de CMFCAppApp
...
// Controladores de mensajes de CMFCAppApp
