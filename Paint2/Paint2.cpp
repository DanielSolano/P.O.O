...
// Paint2.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Único objeto CPaint2App

CPaint2App theApp;


// Inicialización de CPaint2App
...
// Controladores de mensajes de CPaint2App
